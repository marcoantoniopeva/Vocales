...
const TrazoI1Component = ({ regresar, siguiente }) => {
  ...
  useEffect(() => {
    ...
    //******** Animación del Trazo (Palo vertical + punto) **********
    const animacionDibujo = Animated.loop(
      Animated.sequence([
        Animated.timing(animProgresoTrazo, { 
          toValue: 100, 
          duration: 4000,  // 4 segundos para el trazo completo
  ...
  return (
    <View style={estilos.container}>
      ...
      <View style={estilos.contenedorLetra}>
        ...
        {/* Imagen de la i minúscula */}
        <Image
          source={require('../../frontend/image/trazo_i.png')}
...
export default TrazoI1Component;